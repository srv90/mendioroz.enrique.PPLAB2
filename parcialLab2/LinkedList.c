...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >=0 && index < ll_len(this))
    {
        ...
        {
            nodoPrev = getNode(this, index-1);
            nodoPrev->pNextNode = nodo->pNextNode;
...
/** \brief devuelve un nuevo linkedlist con los elementos que pasa la funcion map
 *
 * \param void*
 * \return LinkedList* ll_map(LinkedList* this, int
 *
 */
...
/** \brief devuelve un nuevo linkedlist con los elementos que pasa la funcion filtro
 *
 * \param LinkedList* this Linkedlist a filtar
